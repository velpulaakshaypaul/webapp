...
RSpec.describe "paidemployment_applications/new", type: :view do
  before(:each) do
    assign(:paidemployment_application, PaidemploymentApplication.new(
      :applicant_id => 1,
      :job_id => 1,
      :application_id => 1,
  ...
  it "renders new paidemployment_application form" do
    render

    assert_select "form[action=?][method=?]", paidemployment_applications_path, "post" do
